(function(e){e.loader.impl(function(){return["ext.gadget.store.VueHelloWorld@49debd17",function(r,a,u,d){e.config.get("wgCanonicalNamespace")==="Special"&&e.config.get("wgCanonicalSpecialPageName")==="Blankpage"&&e.config.get("wgTitle").endsWith("/HelloWorld")&&e.loader.using(["vue","@wikimedia/codex"]).then(o=>{const n=o("vue"),c=o("@wikimedia/codex"),i=n.reactive({count:0,increment(){this.count++}}),t=n.createMwApp({template:`
            <component-a/>
            <component-b/>
