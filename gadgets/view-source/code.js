...
(function (module, mw, $) {
	...
	function loadFallbackMessages() {
		mw.messages.set({
			'View-Source__viewSource': "View source",
			'View-Source__viewArticle': "View article",
			'View-Source__tooltip': "Toggle the visibility of the wiki source code of the current page"
		});
		return {
			msg: function () {
				arguments[0] = "View-Source__" + arguments[0];
