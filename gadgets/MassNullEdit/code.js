...
(function ($, mw) {
    ...
    function initDependencies() {
    	var required = ['ext.gadget.fandoom-ui-utils-qdmodal', 'ext.gadget.powertools-placement'];
    ...
    function loadMessages() {
		...
		if (mw.loader.getState('ext.gadget.i18n-js')) {
			...
			mw.hook('dev.i18n').add(function (i18n) {
				i18n.loadMessages('MediaWiki:MassNullEdit', { apiEntrypoint: 'self' })
					.done(function (messages) {
						deferred.resolve((messages || loadFallbackMessages()).msg); 
					});
			});
			return deferred;
		}
		deferred.resolve(loadFallbackMessages().msg);
		return deferred;
	}
	function loadFallbackMessages() {
		mw.messages.set({
			"MassNullEdit__title": "Mass Null Edit",
			"MassNullEdit__instructions": "Enter the name of each page to null edit on a separate line. Remember to include the namespace too if it is not in main.",
			"MassNullEdit__notice-output": "Any notices will appear here",
			"MassNullEdit__notice-ratelimit": "\u003Cb\u003ERate limited!\u003C/b\u003E Waiting 30 seconds before next edit.",
			"MassNullEdit__notice-finished": "\u003Cb\u003EFinished!\u003C/b\u003E Any pages with failed edits have been re-added above.",
			"MassNullEdit__notice-success-backlinks": "\u003Cb\u003EAdded pages!\u003C/b\u003E $2 {{PLURAL:$2|page|pages}} that {{PLURAL:$2|links|link}} to “$1” added.",
			"MassNullEdit__notice-success-transclusions": "\u003Cb\u003EAdded pages!\u003C/b\u003E $2 {{PLURAL:$2|page|pages}} that {{PLURAL:$2|transcludes|transclude}} “$1” added.",
			"MassNullEdit__notice-success-fileusage": "\u003Cb\u003EAdded pages!\u003C/b\u003E $2 {{PLURAL:$2|page|pages}} that {{PLURAL:$2|includes|include}} the file “$1” added.",
			"MassNullEdit__notice-success-prefix": "\u003Cb\u003EAdded pages!\u003C/b\u003E $2 {{PLURAL:$2|page|pages}} with the prefix “$1” added.",
			"MassNullEdit__notice-success-category": "\u003Cb\u003EAdded pages!\u003C/b\u003E $2 {{PLURAL:$2|page|pages}} from “$1” category added.",
			"MassNullEdit__notice-success-namespace": "\u003Cb\u003EAdded pages!\u003C/b\u003E $2 {{PLURAL:$2|page|pages}} from “$1” namespace added.",
			"MassNullEdit__notice-error-backlinks": "\u003Cb\u003EAPI error!\u003C/b\u003E Failed to get pages that link to “$1”: \u003Cb\u003E$2\u003C/b\u003E.",
			"MassNullEdit__notice-error-transclusions": "\u003Cb\u003EAPI error!\u003C/b\u003E Failed to get pages that transclude “$1”: \u003Cb\u003E$2\u003C/b\u003E.",
			"MassNullEdit__notice-error-fileusage": "\u003Cb\u003EAPI error!\u003C/b\u003E Failed to get pages that include the file “$1”: \u003Cb\u003E$2\u003C/b\u003E.",
			"MassNullEdit__notice-error-prefix": "\u003Cb\u003EAPI error!\u003C/b\u003E Failed to get pages with the prefix “$1”: \u003Cb\u003E$2\u003C/b\u003E.",
			"MassNullEdit__notice-error-category": "\u003Cb\u003EAPI error!\u003C/b\u003E Failed to get pages from “$1” category: \u003Cb\u003E$2\u003C/b\u003E.",
			"MassNullEdit__notice-error-namespace": "\u003Cb\u003EAPI error!\u003C/b\u003E Failed to get pages from “$1” namespace: \u003Cb\u003E$2\u003C/b\u003E.",
			"MassNullEdit__cancel": "Cancel",
			"MassNullEdit__pause": "Pause",
			"MassNullEdit__initiate": "Start",
			"MassNullEdit__addpages": "Add pages",
			"MassNullEdit__addpages-backlinks": "Add pages that link to:",
			"MassNullEdit__addpages-transclusions": "Add pages that transclude:",
			"MassNullEdit__addpages-fileusage": "Add pages that include the file:",
			"MassNullEdit__addpages-prefix": "Add pages with the prefix:",
			"MassNullEdit__addpages-category": "Add members of category:",
			"MassNullEdit__addpages-namespace": "Add pages from namespace:",
			"MassNullEdit__namespace-main": "(Main)",
			"MassNullEdit__processing": "Processing…",
			"MassNullEdit__confirm-big-request": "This request will be big (more than $1 pages) and may be slow. Do you want to continue?",
			"MassNullEdit__success": "Null edit of “$1” successful!",
			"MassNullEdit__fail": "Failed to null edit “$1”: \u003Cb\u003E$2\u003C/b\u003E."
		});
		return {
			msg: function () {
				arguments[0] = "MassNullEdit__" + arguments[0];
