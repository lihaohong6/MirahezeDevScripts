...
(function() {
  ...
  */
  Modal.prototype.setContent = function(content) {
    if (
      ...
      content instanceof Modal.prototype.deps.OO.ui.Layout
    ) {
    ...
    if (this._modal) {
      if (this.content instanceof Modal.prototype.deps.OO.ui.Layout) {
  ...
  Modal.prototype.create = function() {
    ...
    OOUIModal.prototype.initialize = function() {
      ...
      if (this._modal.content instanceof Modal.prototype.deps.OO.ui.Layout) {
        ...
        this.content = new Modal.prototype.deps.OO.ui.PanelLayout({
          expanded: false,
          padded: false
        });
      }
  ...
  */
  ...
  mw.loader.using(['oojs', 'oojs-ui', 'oojs-ui-windows']).then(function () {
    // Prepare exports.
    Modal.prototype.deps.OO = OO;	// Late binding
    module.Modal = Modal;
